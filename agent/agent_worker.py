...
AZURE_OPENAI_API_VERSION = os.getenv("OPENAI_API_VERSION", "2024-10-01-preview")
...
async def entrypoint(ctx: agents.JobContext):
    ...
    session = AgentSession[UserData](
        ...
        stt=openai.STT.with_azure(
            model="gpt-4o-mini-transcribe", api_version="2025-03-01-preview"
        ),
...
if __name__ == "__main__":
    ...
    agents.cli.run_app(
        agents.WorkerOptions(
            entrypoint_fnc=entrypoint, agent_name=(f"kisee-agent-{PYTHON_ENV}")
        )
    )
